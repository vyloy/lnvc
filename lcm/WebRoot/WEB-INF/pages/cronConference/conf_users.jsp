	...
	<table border="0" cellspacing="1" cellpadding="0" class="tab_data_table">
		...
		<s:iterator value="userList" id="user">
			<tr class="dialogue_tab_tr">
				<s:if test="conf.users.contains(#user)">
					<td><input type="checkbox" checked="checked" name="userId" value="<s:property value='#user.id' />" /></td>
				</s:if>
				<s:else>
					<td><input type="checkbox" name="userId" value="<s:property value='#user.id' />" /></td>
				</s:else>
