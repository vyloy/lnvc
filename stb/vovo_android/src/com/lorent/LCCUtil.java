...
//				setDoNotDisturb(0);
	...
	public Handler handler_dnd = new Handler() {
		public void handleMessage(Message msg) {
//			setDoNotDisturb(0);
			System.out.println("取消免打扰  ： setDoNotDisturb(0)");
		};
	};
	// 设置免打扰
	public BroadcastReceiver MsgSet = new BroadcastReceiver() {
		...
		public void onReceive(Context arg0, Intent arg1) {
			...
			System.out.println(" msgset: 设置免打扰    setDoNotDisturb(1)");
//			setDoNotDisturb(1);
...
//				setDoNotDisturb(1);
	...
	public void init() {
		...
		try {
			/* 涓嬮潰鎷疯礉package涓殑linphone_config鍒?data/data/com.lorent/files/ */
...
//	}
	...
	public static void hangup() {
		Log.d(TAG, "挂断");
		System.out.println(TAG + " 挂断");
		hangup(call_index2);
	}

	public static void answer() {
		Log.d(TAG, "接听");
		System.out.println(TAG + " 接听");
		answer(call_index2);
	}
