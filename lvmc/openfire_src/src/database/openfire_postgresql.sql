...
-------------------------jack update--------------------
--	add for save properties
alter table ofMucConversationLog add column props TEXT;
--	muc chat log timeout 30s
INSERT INTO ofmucserviceprop (serviceid, name, propvalue) VALUES (1, 'tasks.log.timeout', '30000');
--	muc chat log batchsize 50 records
INSERT INTO ofmucserviceprop (serviceid, name, propvalue) VALUES (1, 'tasks.log.batchsize', '50');

INSERT INTO ofproperty (name, propvalue) VALUES ('provider.auth.className', 'org.jivesoftware.openfire.auth.JDBCAuthProvider');
INSERT INTO ofproperty (name, propvalue) VALUES ('jdbcProvider.driver', 'org.postgresql.Driver');
INSERT INTO ofproperty (name, propvalue) VALUES ('jdbcProvider.connectionString', 'jdbc:postgresql://127.0.0.1:5432/lcmDB_Dev?user=lcmadmin&password=password');
INSERT INTO ofproperty (name, propvalue) VALUES ('jdbcAuthProvider.passwordSQL', 'SELECT password FROM openfireuser WHERE username=?');
...
INSERT INTO ofproperty (name, propvalue) VALUES ('jdbcUserProvider.loadUserSQL', 'SELECT name,email FROM openfireuser WHERE username=?');
INSERT INTO ofproperty (name, propvalue) VALUES ('jdbcUserProvider.userCountSQL', 'SELECT COUNT(*) FROM openfireuser');
INSERT INTO ofproperty (name, propvalue) VALUES ('jdbcUserProvider.allUsersSQL', 'SELECT username FROM openfireuser');
INSERT INTO ofproperty (name, propvalue) VALUES ('jdbcUserProvider.searchSQL', 'SELECT username FROM openfireuser WHERE');
...
INSERT INTO ofproperty (name, propvalue) VALUES ('admin.authorizedJIDs', 'admin@localhost');
INSERT INTO ofproperty (name, propvalue) VALUES ('stun.external.addresses', '');
INSERT INTO ofproperty (name, propvalue) VALUES ('plugin.userservice.secret', '123');
INSERT INTO ofproperty (name, propvalue) VALUES ('plugin.userservice.enabled', 'true');
...
INSERT INTO ofproperty (name, propvalue) VALUES ('xmpp.offline.type', 'store_and_bounce');
