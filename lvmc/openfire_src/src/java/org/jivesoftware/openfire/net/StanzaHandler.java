...
public abstract class StanzaHandler {
    ...
    public void process(String stanza, XMPPPacketReader reader) throws Exception {
        ...
        System.out.println("sessionCreated===========" + sessionCreated);
        System.out.println("initialStream===========" + initialStream);
    ...
    private void process(Element doc) throws UnauthorizedException {
        ...
        else if ("presence".equals(tag)) {//解析登录状态信息
            Presence packet;
            try {
