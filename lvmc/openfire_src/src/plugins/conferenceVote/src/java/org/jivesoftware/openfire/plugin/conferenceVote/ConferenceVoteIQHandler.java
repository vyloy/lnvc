...
public class ConferenceVoteIQHandler extends IQHandler{   

	
	private static final Logger Log = LoggerFactory.getLogger(ConferenceVoteIQHandler.class);
//    public static final String moduleName = "test";   
       
    private IQHandlerInfo info;   
    public ConferenceVoteIQHandler(){   
    ...
    public List doHandle(IQ packet) throws UnauthorizedException{
        ...
        Log.info("doHandle" + "command=="+command);
