...
public interface Figure extends Cloneable, Serializable, DOMStorable {
	 ...
	 * @param tx
	 */
	void translate(IdentifiableTransform tx);
	 ...
	 * @return
	 */
	LinkedList<IdentifiableTransform> translateFinished(AffineTransform tf, AffineTransform anchor, DrawingView drawingView);
	 ...
	 * @param b
	 */
	void translate(IdentifiableTransform tx, boolean b);
}
