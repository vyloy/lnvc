...
import org.jhotdraw.samples.svg.figures.Unselectable;
...
public abstract class AbstractTool implements Tool {
    ...
    public void editDelete() {
    	Collection<Figure> selectedFigures = getView().getSelectedFigures();
    	Client.getInstance().broadcast(new Delete().add(selectedFigures));
		getView().getDrawing().removeAll(selectedFigures);
     ...
     */
    public void editCut() {
    	EditableComponent v=(EditableComponent) getView();
    	v.cut();
    }
    /**
    ...
    public void updateCursor(DrawingView view, Point p) {
        ...
        if (handle != null) {
            ...
            if (figure != null&&!(figure instanceof Unselectable)) {
