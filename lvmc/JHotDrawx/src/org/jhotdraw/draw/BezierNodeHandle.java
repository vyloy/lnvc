...
import org.jhotdraw.samples.svg.figures.SetNode;
...
oldNode = figure.getNode(index);
    ...
    public void trackEnd(Point anchor, Point lead, int modifiersEx) {
        ...
        Node v = f.getNode(index);
        view.getDrawing().fireUndoableEditHappened(new BezierNodeEdit(f,index,oldNode,v));
        view.getDrawing().fireUndoableEditHappened(edit);
        f.dragged();
        Client.getInstance().broadcast(new SetNode(f,index,v));
    }
