...
import org.jhotdraw.samples.svg.figures.ChangeRadius;
...
public class RoundRectRadiusHandle extends AbstractHandle {
    ...
    public void trackEnd(Point anchor, Point lead, int modifiersEx) {
        ...
        RoundRectangleFigure owner = (RoundRectangleFigure) getOwner();
        if(owner instanceof RemoteFigure){
        	Client.getInstance().broadcast(new ChangeRadius(owner, owner.getArcWidth(),owner.getArcHeight()));
        }
    }
}
