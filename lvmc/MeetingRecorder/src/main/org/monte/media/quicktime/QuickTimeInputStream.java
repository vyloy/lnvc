 ...
 * @version $Id: QuickTimeInputStream.java 266 2012-08-07 07:54:05Z werner $
 */
public class QuickTimeInputStream extends AbstractQuickTimeStream {
    ...
    /** Gets the preferred rate at which to play
     ...
     * <p>
     * The media time scale is used for specifying the duration of samples
     * in a track.
     *
    ...
    private void parseVideoTrack(VideoTrack t, HashMap<String, InputAtom> atoms) throws IOException {
        parseTkhd(t, atoms.get("moov.track.tkhd").data);
    }
    ...
    private void parseTkhd(Track t, byte[] data) throws IOException {
        ...
        int version = i.readByte();
        i.skipBytes(2);
        int trackHeaderFlags = i.readByte();
        Date creationTime = i.readMacTimestamp();
        Date modificationTime = i.readMacTimestamp();
        int trackId = i.readInt();
        i.skipBytes(4);
        long duration = i.readUInt();
        i.skipBytes(8);
        int layer = i.readUShort();
        int alternateGroup = i.readUShort();
        double volume = i.readFixed8D8();
        i.skipBytes(2);

        // {a, b, u,
        //  c, d, v,
        //  tx,ty,w} // X- and Y-Translation
        t.matrix[0] = i.readFixed16D16();
        t.matrix[1] = i.readFixed16D16();
        t.matrix[2] = i.readFixed2D30();
        t.matrix[3] = i.readFixed16D16();
        t.matrix[4] = i.readFixed16D16();
        t.matrix[5] = i.readFixed2D30();
        t.matrix[6] = i.readFixed16D16();
        t.matrix[7] = i.readFixed16D16();
        t.matrix[8] = i.readFixed2D30();

        t.width = i.readFixed16D16();
        t.height = i.readFixed16D16();
    }
