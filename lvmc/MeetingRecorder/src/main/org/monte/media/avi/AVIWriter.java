 ...
 * @(#)AVIWriter.java
 *
 * Copyright (c) 2011 Werner Randelshofer, Immensee, Switzerland. All rights
 * reserved.
 *
 ...
 * @version $Id: AVIWriter.java 280 2012-11-20 20:30:22Z werner $
 */
    ...
    private void createCodec(Track tr) {
        ...
        if (tr.codec != null) {
            if (fmt.get(MediaTypeKey) == MediaType.VIDEO) {
                tr.codec.setInputFormat(fmt.prepend(EncodingKey, ENCODING_BUFFERED_IMAGE, DataClassKey, BufferedImage.class));
                if (null == tr.codec.setOutputFormat(fmt.prepend(FixedFrameRateKey, true))) {
