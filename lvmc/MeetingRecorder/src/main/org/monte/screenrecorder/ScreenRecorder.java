 ...
 * @version $Id: ScreenRecorder.java 285 2012-11-21 21:04:07Z werner $
 */
...
System.out.println("AudioGrabber format:"+audioFormat);
System.out.println("AudioGrabber desired line-format:"+AudioFormatKeys.toAudioFormat(audioFormat));
System.out.println("AudioGrabber actual line-format:"+line.getFormat());
        ...
        private float computeAudioLevelSigned16BE(byte[] data, int offset, int length, int stride) {
            ...
            //System.out.println("rms:" + rms + " max:" + max + " min:" + min);
        ...
        private float computeAudioLevelSigned8(byte[] data, int offset, int length, int stride) {
            ...
            //System.out.println("rms:" + rms + " max:" + max + " min:" + min + " num:" + (((length) / stride)));
